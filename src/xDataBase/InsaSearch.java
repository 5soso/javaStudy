...
public class InsaSearch extends JFrame {
	...
	public InsaSearch(InsaVO vo) {
		...
		if(ymds[1].substring(0,1).equals("0")) ymds[1]=ymds[1].substring(1); //월
		if(ymds[2].substring(0,1).equals("0")) ymds[2]=ymds[2].substring(1); //일
//		System.out.println("ymds : " + ymds[1]);
