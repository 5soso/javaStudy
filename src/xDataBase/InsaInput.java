...
public class InsaInput extends JFrame {
	...
	public InsaInput() {
		...
		setVisible(true); //나를 생성하는 시점에서 보여달라
...
//								txtAge.setText("");
//								rdMale.setSelected(true);
//								txtName.requestFocus(); //커서는 이름으로 보낸다?
								btnReset.doClick(); //호출
							}
						}
					}
		...
		btnReset.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				vo = service.getDefaultDate(); //년,월,일 세개를 한번에 담아다니고 싶으니까 vo에 담아서 객체로 가져온다. 
