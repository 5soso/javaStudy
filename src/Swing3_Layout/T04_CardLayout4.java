...
public class T04_CardLayout4 extends JFrame {
	...
	public T04_CardLayout4() {
		...
		//btn1.setIcon();
		btn1 = new JButton(new ImageIcon("./images/1.jpg"));
		btn2 = new JButton(new ImageIcon("./images/2.jpg"));
		btn3 = new JButton(new ImageIcon("./images/3.jpg"));
		btn4 = new JButton(new ImageIcon("./images/4.jpg"));
